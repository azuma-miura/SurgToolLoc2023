...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='hdd/anns/09-13/train_anns3.json',
        img_prefix='hdd/training_imgs/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='hdd/anns/09-13/val_anns3.json',
        img_prefix='hdd/training_imgs/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
classes = ('needle driver', 'force bipolar', 'cadiere forceps',
           'monopolar curved scissor', 'bipolar forceps', 'grasping retractor',
           'vessel sealer', 'clip applier', 'prograsp forceps',
           'tip up fenestrated grasper', 'permanent cautery hook spatula',
           'suction irrigator', 'stapler', 'bipolar dissector')
work_dir = 'work_dirs'
auto_resume = False
gpu_ids = range(0, 2)
